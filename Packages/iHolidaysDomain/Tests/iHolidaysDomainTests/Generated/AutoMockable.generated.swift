...
class HolidaysRepositoryMock: HolidaysRepository {
    //MARK: - getHolidays
    ...
    var getHolidaysCountryYearReturnValue: Single<[Holiday]>!
    var getHolidaysCountryYearClosure: ((String, UInt) -> Single<[Holiday]>)?
...
class PicsumRepositoryMock: PicsumRepository {
    //MARK: - getImages
    ...
    var getImagesPageLimitReturnValue: Single<[PicsumImage]>!
    var getImagesPageLimitClosure: ((UInt, UInt) -> Single<[PicsumImage]>)?
